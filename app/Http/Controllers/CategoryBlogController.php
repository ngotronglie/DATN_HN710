...
class CategoryBlogController extends Controller
{
    ...
    public function store(StoreCategoryBlogRequest $request)
    {
        ...
        return redirect()->route('category_blogs.index')->with('success', 'Thêm mới thành công');
    }
    ...
    public function update(UpdateCategoryBlogRequest $request, CategoryBlog $categoryBlog)
    {
        ...
        return redirect()->route('category_blogs.index')->with('success', 'Cập nhật thành công');
    }
    ...
    {
        $categoryBlog->delete();
        return redirect()->route('category_blogs.index')->with('success', 'Xóa thành công');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->route('category_blogs.trashed')->with('success', 'Khôi phục thành công');
    }
    ...
    public function forceDelete($id)
    {
        ...
        return redirect()->route('category_blogs.trashed')->with('success', 'Danh mục bài viết đã xóa vĩnh viễn');
    }
}
