...
<script src="{{ asset('theme/client/assets/js/plugins/nice-select.min.js') }}"></script>
<script src="{{ asset('theme/client/assets/js/plugins/jquery.ajaxchimp.min.js') }}"></script>
...
<script src="{{ asset('theme/client/assets/js/vendor/jquery-3.6.0.min.js') }}"></script> <!-- Tải jQuery trước -->
<script src="{{ asset('theme/client/assets/js/vendor/jquery-migrate-3.3.2.min.js') }}"></script> <!-- Nếu cần -->
<script src="{{ asset('theme/client/assets/js/vendor/bootstrap.bundle.min.js') }}"></script> <!-- Sau jQuery -->
<script src="{{ asset('theme/client/assets/js/vendor/modernizr-3.11.2.min.js') }}"></script>
