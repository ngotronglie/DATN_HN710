...
@section('content')
    <form method="GET" action="{{ route('admin.products.index') }}" class="d-flex align-items-end">
                                ...
                                <tbody>
                                    @foreach ($products as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ Storage::url($item->img_thumb) }}" alt="{{ $item->name }}"
                                            ...
                                            <td class="d-flex">
                                                ...
                                                <a class="btn btn-warning mr-2"
                                                    href="{{ route('admin.products.edit', $item) }}" title="Sửa"><i
